...
from Data_Reader import BuildSample
...
# data file name
FILE_NAME = '/lustre/cmswork/nlai/NPL_CODE/1D/TEST/ref.txt' # args.input 
...
N_ref = args.reference # usually 500'000
...
# FULL REFERENCE
HLF_REF = BuildSample(FILE_NAME=FILE_NAME, n=N_ref)
print('Reference DF shape:')
print(HLF_REF.shape)

# TOY
HLF_SIG = BuildSample(FILE_NAME=FILE_NAME, n=N_Bkg_p)
