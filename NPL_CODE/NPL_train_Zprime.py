...
#output path
OUTPUT_PATH = args.output #sys.argv[1]
#toy
toy = args.toys #sys.argv[2]
#signal path
INPUT_PATH_SIG = args.input #sys.argv[3] #EX: '/eos/project/d/dshep/BSM_Detection/DiLepton_Zprime300'

#background path                                                                                                                                           
INPUT_PATH_BKG = '/lustre/cmswork/dalsanto/Z_prime/data/DiLepton_SM/' #'/eos/project/d/dshep/BSM_Detection/DiLepton_SM/'
...
total_epochs = 300000 #CAMBIAREEEEE
...
OUTPUT_FILE_ID = '/Toy5D_patience'+str(patience)+'_'+str(N_ref)+'ref_'+str(N_Bkg)+'_'+str(N_Sig)+'_'+str(toy)
