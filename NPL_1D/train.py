...
def build_data(n_background: int, n_signal: int):
    '''costruisce il dataframe della distribuzione'''
    
    data_instance = DataCreator()
    data_df = data_instance.make_distribution(n_background=n_background, n_signal=n_signal)
...
#     BSMfinder = NPL_Model_v5(feature.shape[1], LATENT_SIZE, LAYERS, WEIGHT_CLIPPING)
